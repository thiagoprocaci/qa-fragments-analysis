...
data$count_i_usage = gsub(',','',as.character(data$count_i_usage))
...
data$count_you_usage = gsub(',','',as.character(data$count_you_usage))
...
data$count_they_usage = gsub(',','',as.character(data$count_they_usage))
...
data$count_she_he_usage = gsub(',','',as.character(data$count_she_he_usage))
