...
data2 = read.csv("biology.csv", header = TRUE, sep = ",")

data2$modularity_class = gsub(',','',as.character(data2$modularity_class))
data2$citations = gsub(',','',as.character(data2$citations))
data2$avg_part = gsub(',','',as.character(data2$avg_part))
