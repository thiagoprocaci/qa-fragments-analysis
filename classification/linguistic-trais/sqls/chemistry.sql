...
I_USAGE as (
	...
	select a.* from count_i_usage_with_profile_chemistry_view a
),
YOU_USAGE as (
	select a.* from count_you_usage_with_profile_chemistry_view a
)
,
SHE_HE_USAGE as (
	select a.* from count_she_he_usage_with_profile_chemistry_view a
)
